...
class Generator {
    ...
    public:
        Generator(int locality_range = 10, //how much of the data vec we draw from at once
                  double locality_shift = 0.5, //how much we shift our "temporal zone" with each call
